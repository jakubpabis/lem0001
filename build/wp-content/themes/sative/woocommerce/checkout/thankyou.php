...
<div class="woocommerce-order container container-xsml">
	...
	<?php if ( $order ) : ?>
		...
		<?php if ( $order->has_status( 'failed' ) ) : ?>
			...
			<p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions text-center">
