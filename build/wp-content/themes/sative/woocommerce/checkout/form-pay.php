...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<button type="submit" class="button alt btn__normal btn__full btn__checkout" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '"><span>' . esc_html( $order_button_text ) . '</span><i class="icon-chevron_right_bold"></i></button>' ); // @codingStandardsIgnoreLine ?>
