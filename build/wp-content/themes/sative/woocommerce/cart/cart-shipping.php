...
<section class="shipping">
	<h3><?php echo wp_kses_post( $package_name ); ?></h3>
		...
		<?php if ( 1 < count( $available_methods ) ) : ?>
			<ul id="shipping_method">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						<?php
							printf( '<input onclick="checkLocal(this);" type="radio" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d_%2$s" value="%3$s" class="shipping_method" %4$s />
								<label for="shipping_method_%1$d_%2$s" onclick="checkLocal(this);">%5$s</label>',
